export const ptBR = {
  ...
  'premium.upgradeDesc': 'Sugestões SEO, geração de meta tags, análise com IA e mais',
  'premium.activateTitle': 'Ativar Licença',
  'premium.activatePlaceholder': 'VPAR-XXXX-XXXX-XXXX',
  'premium.activateBtn': 'Ativar',
  'premium.activated': 'Premium ativado com sucesso!',
  'premium.invalid': 'Chave de licença inválida.',
  'premium.networkError': 'Não foi possível validar. Verifique sua conexão.',
  'premium.invalidFormat': 'Formato inválido. Esperado: VPAR-XXXX-XXXX-XXXX',
  'premium.deactivate': 'Desativar',
  'premium.deactivated': 'Licença desativada.',
  'premium.required': 'Este recurso requer Premium.',
  'premium.active': 'Premium ativo',
  'premium.fixSeo': 'Corrigir SEO',
  'premium.aiSuggest': 'Sugestões IA',
  'premium.exportReport': 'Exportar Relatório SEO',
  'preview.useButton': 'Use o botão "Preview" nos resultados do pré-render.',
};
